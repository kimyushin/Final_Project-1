...
from parsing_2 import ref_IL1, ref_L1,L1,L2,L3,L4,L5,L6
...
for i in range(0,len(ref_L1)):
    ...
    p1_list_fit.append(p6(L1[i]).tolist())
    p2_list_fit.append(p6(L2[i]).tolist())
    p3_list_fit.append(p6(L3[i]).tolist())
    p4_list_fit.append(p6(L4[i]).tolist())
    p5_list_fit.append(p6(L5[i]).tolist())
    p6_list_fit.append(p6(L6[i]).tolist())
